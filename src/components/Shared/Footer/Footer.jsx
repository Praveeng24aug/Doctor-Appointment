						...
						<div className="col-12 col-sm-6 col-lg-3">
							<div className="footer-widget footer-contact">
								...
								<div className="footer-contact__item">
									...
									<p>1124 Alpha 1, Greater Noida,<br /> Uttar Pradesh, INDIA 201310</p>
								</div>
								<div className="footer-contact__item">
									<FaPhoneAlt className="footer-contact__icon" />
									<p><a href="tel:+91 (555) 123-4567">+91 (555) 123-4567</a></p>
								</div>
								<div className="footer-contact__item">
									<FaEnvelope className="footer-contact__icon" />
									<p><a href="mailto:uniquesingh30@gmail.com">uniquesingh30@gmail.com</a></p>
								</div>
							</div>
						</div>
					</div>
